...
class CustomOfferTypeDropdownButton extends StatefulWidget {
  ...
  const CustomOfferTypeDropdownButton({super.key,
    required this.items,
    required this.value,
  ...
  @override
  State<CustomOfferTypeDropdownButton> createState() => _CustomOfferTypeDropdownButtonState();
}

class _CustomOfferTypeDropdownButtonState extends State<CustomOfferTypeDropdownButton> {
