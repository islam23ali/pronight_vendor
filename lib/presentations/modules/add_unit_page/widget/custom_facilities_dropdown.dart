...
class CustomFacilitiesDropdownButton extends StatefulWidget {
  ...
  final bool? isCenter;
  final OneConten? selectedContent;
  ...
  const CustomFacilitiesDropdownButton({super.key,
    ...
    this.width,
    this.inputColor,
    this.iconDisabledColor, this.isCenter, this.textStyle, this.hint, this.height, this.selectedContent,
  });
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton2<OneConten>(
          isExpanded: true,
          ...
          items: widget.items.map((OneConten item) => DropdownMenuItem<OneConten>(
            value: item,
            child:Column(
