...
class BookingDaysPage extends StatefulWidget {
  const BookingDaysPage({super.key});
...
class _BookingDaysPageState extends State<BookingDaysPage> {
  ...
  Widget build(BuildContext context) {
    return CustomScaffold(
      ...
      appBar: CustomAppBar(title: 'أيام الحجز',height: 65.h,bgColor: Color(0xffF6FFFA),topColor: Color(0xffF6FFFA),statusBarColor: Color(0xffF6FFFA),),
      body: Padding(
                      ...
                      return AnimationConfiguration.staggeredGrid(
                          ...
                          child: ScaleAnimation(
                              ...
                              Padding(
                                ...
                                child: Material(elevation: 4,borderRadius:BorderRadius.circular(8.r),color: Color(0xffFFFFFF),
                                  child: Container(
                                    padding: EdgeInsets.all(16.r),
                                    decoration: BoxDecoration(border: Border.all(width: 1.w,color: Color(0xff9F9F9F)),color: Color(0xffFFFFFF),borderRadius: BorderRadius.circular(8.r)),
