                    ...
                    children: [
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Row(
                            children: [
                              CustomText(title: '50',fontSize: AppFonts.font_20,fontWeight: FontWeight.bold,),
                              SizedBox(width: 5.w),
                    ...
                    children: [
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Row(
                            children: [
                              CustomText(title: '20',fontSize: AppFonts.font_20,fontWeight: FontWeight.bold,),
                              SizedBox(width: 5.w),
                              CustomText(title: AppTranslate.unit.tr(),fontSize: AppFonts.font_12,fontColor: AppColors.textColor,),
                            ],
                          ),
