...
class _EditCatBottomSheetState extends State<InviteFriendSheet> {
  ...
  void initState() {
    super.initState();
    controller.text='https://apps.apple.com /us/app/2cklks;l;';
  }
  @override
      ...
      child: Column(
              ...
              children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                  CustomTextFormField(controller: controller,width: 316.w,height: 42.h,underLineColor: Colors.transparent,
                    bgColor: Color(0xffEEECEC),
                    prefix:  CustomSvgIcon(assetName: AppAssets.apple,width: 25.w,height: 25.h),),
                  CustomSvgIcon(assetName: AppAssets.copy,width: 25.w,height: 25.h),
                ],),
