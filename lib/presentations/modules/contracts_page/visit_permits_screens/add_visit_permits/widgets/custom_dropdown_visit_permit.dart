...
class CustomDropdownVisitPermitButton extends StatefulWidget {
  ...
  const CustomDropdownVisitPermitButton({super.key,
    required this.items,
    required this.value,
  ...
  @override
  State<CustomDropdownVisitPermitButton> createState() => _CustomDropdownVisitPermitButtonState();
}

class _CustomDropdownVisitPermitButtonState extends State<CustomDropdownVisitPermitButton> {
