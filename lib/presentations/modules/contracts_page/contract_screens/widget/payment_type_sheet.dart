...
import 'package:pronight_vendor/presentations/modules/contracts_page/contract_screens/widget/success_payed_sheet.dart';
...
class PaymentTypeSheet extends StatefulWidget {
  ...
  const PaymentTypeSheet({super.key,  this.price, this.contractId});
        ...
        CustomText(title: AppTranslate.payment.tr(),fontSize: AppFonts.font_14,fontWeight: FontWeight.bold,),
          ...
          Padding(padding: EdgeInsets.symmetric(horizontal: Dimens.padding_16),
            child: Column(crossAxisAlignment: CrossAxisAlignment.start,
              ...
              CustomText(title: '${widget.price??''} ${AppTranslate.saudiRiyal.tr()}',fontColor: AppColors.textColor2,fontSize: AppFonts.font_11,),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
            ...
            CustomButton(onTap: (){
              ...
              // }
              // else{
              provider.payContract(widget.contractId??'');
