...
class CustomUnitCard extends StatefulWidget {
  const CustomUnitCard({super.key});
    ...
    return Card(color: AppColors.white,surfaceTintColor: AppColors.white,elevation: 4,
      child:Padding(
        ...
        child: Row(mainAxisSize: MainAxisSize.max,
          ...
          children: [
            AppNetworkImage(imageUrl: 'imageUrl',width: 67.87.w,height: 69.w,borderRadius: 10.r,errorImage: AppAssets.bgItemDetails,fit: BoxFit.cover,),
              ...
              child: Column(
                ...
                children: [
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      CustomText(title: 'فندق الأندلس مول',fontSize: AppFonts.font_11,fontWeight: FontWeight.w500,),
                  ...
                  CustomText(title: 'فندق العصري الملحق بمركز Red Sea التجاري بالرياض',fontSize: AppFonts.font_8,fontColor: AppColors.textColor,),
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Row(children: [
                        CustomSvgIcon(assetName: AppAssets.address,width: 14.w,height: 14.h,color: AppColors.primaryColor,),
                        SizedBox(width: 5.w),
                        CustomText(title: 'الرياض',fontSize: AppFonts.font_9,fontColor: AppColors.textColor2,),
                      ]),
                      RateWidget(itemSize: 12.r,initialRating: 5,)
                    ],
                  )
                ],),
            )
